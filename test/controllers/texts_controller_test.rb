...
class TextsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create text" do
    assert_difference('Text.count') do
      post texts_url, params: { text: { article_id: @text.article_id, headline: @text.headline, likes: @text.likes, order: @text.order, text: @text.text } }
    end
  ...
  test "should update text" do
    patch text_url(@text), params: { text: { article_id: @text.article_id, headline: @text.headline, likes: @text.likes, order: @text.order, text: @text.text } }
